...
//This is not use in Android 4.0
#if 0
...
static struct i2c_board_info __initdata bma250_i2c_info = { I2C_BOARD_INFO(BMA250_DEV_NAME, 
 	BMA250_I2C_SLAVE_WRITE_ADDR)};
/*----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------*/
static int bma250_ioctl(struct file *file, unsigned int cmd,
       unsigned long arg)
{
...
{
	GSE_FUN();
	i2c_register_board_info(0, &bma250_i2c_info, 1);
