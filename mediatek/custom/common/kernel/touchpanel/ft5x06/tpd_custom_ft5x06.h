...
#define TPD_YMAX_NB		868

#define TPD_YMAX_BYD		861
...
#ifdef TINNO_ANDROID_S9050
//We do not need touch to report KEY_MENU in S9091
#define TPD_KEYS                {KEY_HOMEPAGE, KEY_UNKNOWN, KEY_BACK, KEY_SEARCH}
#else
...
// |                                                                                                   |
// |                                                                                                   |  Touch Pad area ( H < 800)
//  ---------------------------------------------------------------------------------------------------
// |                                           TPD_Y_OFFSET                                            |  Virtual key area ( H > 800)
// |---------------------------------------------------------------------------------------------------
// |TPD_B1_FP | [TPD_B1_W] | TPD_B2_FP | [TPD_B2_W] | TPD_B3_FP | [TPD_B3_W] | TPD_B4_FP | [TPD_B4_W]  |  
// -----------------------------------------------------------------------------------------------------

#define TPD_B1_FP	20		//Button 1 pad space
...
#define TPD_B4_FP	40		//Button 4 pad space
...
#define TPD_KEYS_DIM_NB    {{TPD_BUTTON1_X_CENTER, TPD_BUTTON_Y_CENTER_NB, TPD_B1_W, TPD_BUTTON_SIZE_HEIGHT_NB},	\
							...
							{TPD_BUTTON4_X_CENTER, TPD_BUTTON_Y_CENTER_NB, TPD_B4_W, TPD_BUTTON_SIZE_HEIGHT_NB}}
...
#define TPD_KEYS_DIM_BYD  {{TPD_BUTTON1_X_CENTER, TPD_BUTTON_Y_CENTER_BYD, TPD_B1_W, TPD_BUTTON_SIZE_HEIGHT_BYD},	\
							...
							{TPD_BUTTON4_X_CENTER, TPD_BUTTON_Y_CENTER_BYD, TPD_B4_W, TPD_BUTTON_SIZE_HEIGHT_BYD}}
...
#define CTP_DBG(fmt, arg...) \
	printk("[CTP-FT5X06] %s (line:%d) :" fmt "\r\n", __func__, __LINE__, ## arg)
#else
