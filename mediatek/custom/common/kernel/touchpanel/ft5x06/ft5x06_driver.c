...
static struct i2c_board_info __initdata ft5x06_i2c_tpd={ I2C_BOARD_INFO(DRIVER_NAME, 
 	TPD_I2C_SLAVE_ADDR2)};
...
#if defined (TINNO_ANDROID_S9091) || defined (TINNO_ANDROID_S9050)	
	strncpy(tpd_desc, "FT5206", sizeof("FT5206"));
...
static void tpd_suspend(struct early_suspend *h)
 ...
 static int __init tpd_driver_init(void) 
 {
	...
	i2c_register_board_info(TPD_I2C_GROUP_ID, &ft5x06_i2c_tpd, 1);
