...
newall: cleanall javaoptgen emigen nandgen ptgen custgen codegen update-api remakeall
else
newall: cleanall javaoptgen emigen nandgen custgen codegen update-api remakeall
endif
        ...
        $(if $(filter update-api,$@),\
          $(if $(filter true,$(strip $(BUILD_TINY_ANDROID))), \
            ...
            $(if $(filter snod userdataimage-nodeps,$@), \
              , \
              /usr/bin/perl mediatek/build/tools/mtkBegin.pl $(FULL_PROJECT) && \
             ) \
...
remake:
	$(hide) /usr/bin/perl mediatek/build/tools/mtkBegin.pl $(FULL_PROJECT)
	$(hide) $(REMAKECMD) ACTION= $(CUR_MODULE)
