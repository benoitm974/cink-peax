...
for(i=0;i<10;i++)
{
	_gFG_current =_gFG_current+ fgauge_read_current();
      _gFG_voltage =_gFG_voltage+ fgauge_read_voltage();
}
       gFG_current=_gFG_current/10;
	gFG_voltage=_gFG_voltage/10;
...
{
printk("FGADC_Get_BatteryCapacity_CoulombMothod:%d \n",gFG_capacity_by_c);
