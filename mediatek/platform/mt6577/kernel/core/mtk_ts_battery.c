...
#define FIX_ARGUMENT_FOR_BAT_THERMAL //add by alik!
...
#ifdef FIX_ARGUMENT_FOR_BAT_THERMAL  //add by alik
trip_temp[0]=70000; //when the battery is 70 degree centigrade,force reset the phone!
num_trip=0;
#endif	
